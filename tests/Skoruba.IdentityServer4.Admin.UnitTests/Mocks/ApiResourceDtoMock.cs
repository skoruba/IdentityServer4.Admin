...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Mocks
{
    public static class ApiResourceDtoMock
    {
        ...
        public static ApiResourcePropertiesDto GenerateRandomApiScopeProperty(int id, int apiScopeId)
        {
            var apiScopePropertyFaker = ApiResourcePropertyFaker(id, apiScopeId);
        ...
        public static Faker<ApiScopesDto> GetApiScopeFaker(int id)
        {
        ...
        public static ApiScopesDto GenerateRandomApiScope(int id)
        {
