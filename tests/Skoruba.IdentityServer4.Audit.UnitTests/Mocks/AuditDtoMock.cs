...
{
    public class AuditDtoMock
    {
        public static Faker<AuditDto> GetAuditFaker(int id)
        {
            var fakerEntity = new Faker<AuditDto>()
                .RuleFor(o => o.Id, id)
        ...
        public static AuditDto GenerateRandomLog(int id)
        {
            var dto = GetAuditFaker(id).Generate();
