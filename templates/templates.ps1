...
$templateSrc = "template/content/src"
$templateTests = "template/content/tests"
$templateAdminProject = "template/content/src/Skoruba.IdentityServer4.Admin"
$templateDataMigrationFolder = "Data/Migrations"

# Clone the latest version from master branch
git clone $gitProject $gitProjectFolder -b feature/extensible-aspnet-identity
...
# Add nuget packages
dotnet add ./$templateSrc/Skoruba.IdentityServer4.Admin/Skoruba.IdentityServer4.Admin.csproj package Skoruba.IdentityServer4.Admin.BusinessLogic -v 1.0.0-beta1
dotnet add ./$templateSrc/Skoruba.IdentityServer4.Admin/Skoruba.IdentityServer4.Admin.csproj package Skoruba.IdentityServer4.Admin.BusinessLogic.Identity -v 1.0.0-beta1-update1
dotnet add ./$templateSrc/Skoruba.IdentityServer4.Admin/Skoruba.IdentityServer4.Admin.csproj package Skoruba.IdentityServer4.Admin.EntityFramework.DbContexts -v 1.0.0-beta1

dotnet add ./$templateSrc/Skoruba.IdentityServer4.AspNetIdentity/Skoruba.IdentityServer4.AspNetIdentity.csproj package Skoruba.IdentityServer4.Admin.EntityFramework.Identity -v 1.0.0-beta1
dotnet add ./$templateSrc/Skoruba.IdentityServer4.AspNetIdentity/Skoruba.IdentityServer4.AspNetIdentity.csproj package Skoruba.IdentityServer4.Admin.EntityFramework.DbContexts -v 1.0.0-beta1
