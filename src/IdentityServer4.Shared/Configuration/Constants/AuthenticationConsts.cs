...
namespace IdentityServer4.Shared.Configuration.Constants
{
    public class AuthenticationConsts
    {
        ...
        public const string OidcClientSecret = "admin_client_secret";
        ...
        public const string IdentityAdminApiSwaggerClientId = "identity_admin_api_swaggerui";
        public const string IdentityAdminApiScope = "identity_admin_api";
