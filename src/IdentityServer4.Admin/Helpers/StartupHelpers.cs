...
using IdentityServer4.Admin.ExceptionHandling;
using IdentityServer4.Admin.Middlewares;
using IdentityServer4.Admin.Configuration;
using IdentityServer4.Admin.Configuration.ApplicationParts;
using IdentityServer4.Admin.EntityFramework.Interfaces;
using IdentityServer4.Admin.Helpers.Localization;
...
namespace IdentityServer4.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        public static IServiceCollection ConfigureAdminRootConfiguration(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddOptions();

            services.Configure<AdminAppConfiguration>(configuration.GetSection(ConfigurationConsts.AdminConfigurationKey));
