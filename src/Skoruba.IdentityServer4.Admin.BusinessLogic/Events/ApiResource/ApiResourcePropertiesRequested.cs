...
{
    public class ApiResourcePropertiesRequested : AuditEvent
    {
        public ApiResourcePropertiesRequested(int apiResourceId, ApiResourcePropertiesDto apiResourceProperties)
        {
