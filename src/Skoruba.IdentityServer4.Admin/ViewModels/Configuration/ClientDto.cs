...
namespace Skoruba.IdentityServer4.Admin.ViewModels.Configuration
{
	public class ClientDto
	{
		...
		public SelectList AccessTokenTypes { get; set; }
        ...
        public SelectList ProtocolTypes { get; set; }

        public int RefreshTokenExpiration { get; set; } = 1;
		public SelectList RefreshTokenExpirations { get; set; }

		public int RefreshTokenUsage { get; set; } = 1;
		public SelectList RefreshTokenUsages { get; set; }
