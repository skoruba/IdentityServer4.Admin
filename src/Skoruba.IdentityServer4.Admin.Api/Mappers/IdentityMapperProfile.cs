...
{
    public class IdentityMapperProfile<TRoleDto, TUserRolesDto, TUserClaimsDto, TUserClaimDto, TUserProviderDto, TUserProvidersDto, TUserChangePasswordDto, TRoleClaimDto, TRoleClaimsDto, TKey> : Profile
        ...
        where TKey : IEquatable<TKey>
    {
        public IdentityMapperProfile()
        {
            ...
            CreateMap<UserRoleApiDto<TKey, TKey>, TUserRolesDto>(MemberList.Destination);
