...
{
    public class ConsentDeniedEventAdapter : IAuditArgs
    {
        private readonly IHttpContextAccessor _httpContext;

        public ConsentDeniedEvent Event { get; }

        public ConsentDeniedEventAdapter(ConsentDeniedEvent evt, IHttpContextAccessor httpContext)
        {
