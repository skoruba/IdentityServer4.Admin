...
namespace Skoruba.IdentityServer4.Admin.AspNetIdentity.Services
{
        ...
        where TUserToken : IdentityUserToken<TKey>
    {
        ...
        public async Task<bool> ExistsUserAsync(string userId)
        {
            ...
            if (!exists) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserDoesNotExist().Description, userId), _identityServiceResources.UserDoesNotExist().Description);
        ...
        public async Task<bool> ExistsRoleAsync(string roleId)
        {
            ...
            if (!exists) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.RoleDoesNotExist().Description, roleId), _identityServiceResources.RoleDoesNotExist().Description);
        ...
        private IdentityResult HandleIdentityError(IdentityResult identityResult, string errorMessage, string errorKey, object model)
        {
            ...
            throw new UserFriendlyViewIdentityException(errorMessage, errorKey, viewErrorMessages, model);
        }
        ...
        public async Task<TRoleDto> GetRoleAsync(TRoleDto role)
        {
            ...
            if (userIdentityRole == null) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.RoleDoesNotExist().Description, role.Id), _identityServiceResources.RoleDoesNotExist().Description);
        ...
        public async Task<TUserDto> GetUserAsync(string userId)
        {
            ...
            if (identity == null) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserDoesNotExist().Description, userId), _identityServiceResources.UserDoesNotExist().Description);
        ...
        public async Task<UserRolesDto<TRoleDto, TUserDtoKey, TRoleDtoKey>> GetUserRolesAsync(string userId, int page = 1, int pageSize = 10)
        {
            ...
            if (!userExists) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserDoesNotExist().Description, userId), _identityServiceResources.UserDoesNotExist().Description);
        ...
        public async Task<UserClaimsDto<TUserDtoKey>> GetUserClaimAsync(string userId, int claimId)
        {
            ...
            if (identityUserClaim == null) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserClaimDoesNotExist().Description, userId), _identityServiceResources.UserClaimDoesNotExist().Description);
        ...
        public async Task<UserProviderDto<TUserDtoKey>> GetUserProviderAsync(string userId, string providerKey)
        {
            ...
            if (identityUserLogin == null) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserProviderDoesNotExist().Description, providerKey), _identityServiceResources.UserProviderDoesNotExist().Description);
        ...
        public async Task<IdentityResult> UserChangePasswordAsync(UserChangePasswordDto<TUserDtoKey> userPassword)
        {
            ...
            if (!userExists) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.UserDoesNotExist().Description, userPassword.UserId), _identityServiceResources.UserDoesNotExist().Description);
        ...
        public async Task<RoleClaimsDto<TRoleDtoKey>> GetRoleClaimsAsync(string roleId, int page = 1, int pageSize = 10)
        {
            ...
            if (!roleExists) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.RoleDoesNotExist().Description, roleId), _identityServiceResources.RoleDoesNotExist().Description);
        ...
        public async Task<RoleClaimsDto<TRoleDtoKey>> GetRoleClaimAsync(string roleId, int claimId)
        {
            ...
            if (identityRoleClaim == null) throw new UserFriendlyErrorPageIdentityException(string.Format(_identityServiceResources.RoleClaimDoesNotExist().Description, claimId), _identityServiceResources.RoleClaimDoesNotExist().Description);
