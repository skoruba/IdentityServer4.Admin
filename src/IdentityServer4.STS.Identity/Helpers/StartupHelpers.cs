...
using IdentityServer4.STS.Identity.Configuration.ApplicationParts;
using IdentityServer4.STS.Identity.Configuration.Constants;
using IdentityServer4.STS.Identity.Helpers.Localization;
using IdentityServer4.STS.Identity.Services;
